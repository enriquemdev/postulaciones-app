...
export const ApplicationFormValidation = [
  ...
  Yup.object({
    applicant_names: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    applicant_last_names: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    applicant_email: Yup.string()
      .email("Email inválido")
      .max(255, "Máximo 255 caracteres")
      .required("Requerido"),
    applicant_phone: Yup.string().max(20, "Máximo 20 caracteres").required("Requerido"),
    ...
    applicant_portfolio_link: Yup.string()
      ...
      .max(255, "Máximo 255 caracteres")
      .nullable(),
    applicant_country: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    applicant_city: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    applicant_address: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
  }),
  // Step 2: Job info
  Yup.object({
    job_title: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    company_name: Yup.string().max(255, "Máximo 255 caracteres").required("Requerido"),
    employment_type_id: Yup.number()
      .oneOf([1, 2], "Seleccione una opción válida") // Asumiendo IDs 1 y 2, ajustar si hay más
      .required("Requerido"),
